...
const addresses = [
  "0xfe47930cca45be75b1cd8529f92bfd26831ee7f8",
  "0xc87388ed245c595433d6edf4ae67005a8e39073a",
  "0x1b1bbd315685bc816ca7f3871bd049cd7bb22a7d",
];
const Portfolio = () => {
  ...
  const getData = async (addr, index) => {
    ...
    try {
      ...
      if (index == 1) setShare1(parseInt(s._hex, 16));
      if (index == 2) setShare2(parseInt(s._hex, 16));
      if (index == 3) setShare3(parseInt(s._hex, 16));
    } catch (e) {
      console.log(e);
    }
  };
    ...
    <>
      <div className="row">
        {share1 == 0 && share2 == 0 && share3 == 0 ? (
          <h1 style={{ textAlign: "center" }}>No investments done</h1>
        ) : (
          <></>
        )}
        {share1 > 0 ? (
            ...
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="card-text">
                  Contract address is:{addresses[0]}
                </h6>
              </div>
            </div>
          </div>
          ...
          <div className="col-sm-12 col-md-6 col-lg-6">
            <div className="card">
              <div className="card-body">
                <img
                  className="card-img-top"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpLKuD8jwlcyC3rADBOpCS5n3r37YEqzxm6Q&usqp=CAU"
                  alt="apartment image"
                />
                <h2 className="card-title">Resorts in Goa</h2>
                <h6 className="card-text">Number of shares bought: {share2}</h6>
                <h6 className="card-text">
                  Contract address is:{addresses[1]}
                </h6>
              </div>
            </div>
          </div>
          ...
          <div className="col-sm-12 col-md-6 col-lg-6">
            <div class="card">
              <div className="card-body">
                <img
                  className="card-img-top"
                  src="https://is1-2.housingcdn.com/01c16c28/27a5a1db1bbe0bf0467d9aa89f0a550c/v0/fs/5_bhk_villa-for-sale-dlf_farms-New+Delhi-others.jpg"
                  alt="apartment image"
                />
                <h2 className="card-title">Villas in Delhi</h2>
                <h6 className="card-text">Number of shares bought: {share3}</h6>
                <h6 className="card-text">
                  Contract address is:{addresses[2]}
                </h6>
              </div>
            </div>
          </div>
